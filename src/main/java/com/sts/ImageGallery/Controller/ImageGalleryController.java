package com.sts.ImageGallery.Controller;
...
import com.sts.ImageGallery.Service.ImageGalleryService;
...
public class ImageGalleryController {
	...
	@Value("${uploadDir}")	//folder storage annotation
...
//			String uploadDirectory = request.getServletContext().getRealPath("")+ File.separator + "uploaded_file";
